...
class DeviceRouter(TreeRouter):
    ...
    def getDevices(self, uid=None, start=0, params=None, limit=50, sort='name',
        ...
        if params and 'name' in params:
            ...
            params['name'] = params['name'].lstrip('*')
            # validating whole regexp and clearing it in case of exception
            try:
    ...
    def setProductionState(self, uids, prodState, hashcheck, uid=None,
        ...
        device_count = 0
        move_job_threshold = (self.context.dmd.UserInterfaceSettings
                                .getInterfaceSettings().get('deviceMoveJobThreshold'))
        ...
        try:
            ...
            async = device_count > move_job_threshold

            facade.setProductionState(uids, prodState, asynchronous=async)
