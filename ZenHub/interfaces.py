...
class IQueueSizeProvider(Interface):
    """
    Interface used to retrieve the sizes of the AMQP queues
    """
    def getQueuesSize():
        """
        @return: Return a dict whose keys are the queue names and value the queue sizes.
        @rtype: dict
        """
