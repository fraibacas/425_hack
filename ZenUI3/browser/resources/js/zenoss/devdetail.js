        ...
        menu: [{
            ...
            handler: function(){
                ...
                if(this.text === 'All'){
                    ...
                    var endRange = grid.store.totalCount < grid.store.pageSize ? 
                        grid.store.totalCount-1 : grid.store.pageSize-1;
                    grid.getSelectionModel().selectRange(0, endRange);                    
                }
            }
	    },{
            text: _t('None'),
...
var createDevDetailEventsGrid = function(re_attach_to_container){
    ...
    event_console.on('recreateGrid', function (grid) {
        ...
        var grid = createDevDetailEventsGrid(true);
