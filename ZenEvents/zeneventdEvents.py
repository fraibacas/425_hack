...
def onBuildOptions(daemon, event):
    ...
    daemon.parser.add_option('--logperfasinfo', dest='logPerfAsInfo', default=False, action='store_true',
                             help='Output perf data at INFO level - otherwise it will log as DEBUG')
    daemon.parser.add_option('--usemetrology', dest='useMetrology', default=False, action='store_true',
