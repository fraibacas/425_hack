...
from Products.ZenRRD.zencommand import SshOptions
...
class TestRunner(ZenScriptBase):
    ...
    def remote_exec(self, cmd):
        ...
        connection_options = SshOptions(self.device.zCommandUsername,
                            self.device.zCommandPassword,
                            self.device.zCommandLoginTimeout,
                            self.device.zCommandCommandTimeout,
                            self.device.zKeyPath, 1)
