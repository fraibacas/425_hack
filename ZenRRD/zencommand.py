...
class SshPerformanceCollectionPreferences(object):
    ...
    def buildOptions(self, parser):
        ...
        parser.add_option('--collectionslimit',
                          dest='collectionslimit',
                          default=COLLECTIONS_LIMIT,
                          type='int',
                          help="Number of collections before reestablishing ssh connection.")
...
class MySshClient(SshClient):
    ...
    def __init__(self, *args, **kw):
        log.info("REACTOR type -> %s", reactor)
...
class SshOptions:
    ...
    def __init__(self, username, password, loginTimeout, commandTimeout,
            keyPath, concurrentSessions, collectionslimit=None):
        ...
        self.collections_limit = collectionslimit
    ...
    def _connect(self):
        ...
        if connection is None:
            ...
            options = SshOptions(username, password,
                              ...
                              self._preferences.options.collectionslimit)
