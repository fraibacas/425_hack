        ...
        def inner(driver):
            ...
            try:
                kw = dict(deviceName=ip,
                          ...
                          productionState=self.options.productionState or
                              self.parser.get_default_values().productionState)
                ...
                if not self.options.nosnmp:
                    ...
                    yield self.findRemoteDeviceInfo(ip, self.options.deviceclass,
                                                    snmpCommunities)
