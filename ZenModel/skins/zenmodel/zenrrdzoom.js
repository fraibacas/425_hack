...
function resetSwoopies(drange,end) {
    end = end || 0;
...
Ext.onReady(function(){
    ...
    var customRangeButton = Ext.get('customdaterange');
    if (customRangeButton) {
        var Dummy = new Object({
            setDrange: resetSwoopies
        });
        customRangeButton.on('click', function(){
            parent.selectCustomDateRange(null, Dummy)
        });
    }
